...
func (h *Handler) Metrics(c *gin.Context) {
	...
	sharedhandler.WriteJSON(c, http.StatusOK, gin.H{
		...
		"broadcast_recipients_delivered": snapshot.BroadcastRecipients.Delivered,
		"broadcast_recipients_read":      snapshot.BroadcastRecipients.Read,
		...
		"tenants_total":                  nil,
		"tenants_total_supported":        false,
		"users_total":                    nil,
		"users_total_supported":          false,
		...
		"totalBroadcastRecipientsDelivered": snapshot.BroadcastRecipients.Delivered,
		"totalBroadcastRecipientsRead":      snapshot.BroadcastRecipients.Read,
		...
		"totalTenants":                      nil,
		"totalTenantsSupported":             false,
		"totalUsers":                        nil,
		"totalUsersSupported":               false,
		...
		"broadcast_recipients": gin.H{
			...
			"delivered": snapshot.BroadcastRecipients.Delivered,
			"read":      snapshot.BroadcastRecipients.Read,
		...
		"metrics_limitations": []string{
			"messages_total reflects stored SaaS conversation history only",
			"runtime health is partial when no durable runtime state has been observed for an instance",
			"tenant and user platform-wide totals are not exposed by this tenant-scoped MVP endpoint",
		},
	})
}
